...
public class ArticuloManufacturadoService {
    ...
    private void fillFromRequest(ArticuloManufacturado manufacturado, ArticuloManufacturadoRequest request) {
    ...
    private ArticuloManufacturadoDetalle toDetalle(RecetaItemRequest item) {
    ...
    private ArticuloResponse toResponse(ArticuloManufacturado manufacturado) {

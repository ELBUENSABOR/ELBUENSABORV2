...
export const SIDEBAR_ROUTES: SidebarRoute[] = [
    ...
    createSidebarRoute("rubros-insumos", "insumos/rubros", "Rubros de insumos", "Clasificación y mantenimiento de rubros de insumos.", Tags, ["COCINERO", "ADMIN"]),
    createSidebarRoute("rubros-productos", "manufacturados/rubros", "Rubros de productos", "Clasificación y mantenimiento de rubros de productos.", Tags, ["COCINERO", "ADMIN"]),
    createSidebarRoute(
...
export const DASHBOARD_PATHS = {
    ...
    rubrosInsumos: "insumos/rubros",
    rubrosProductos: "manufacturados/rubros",

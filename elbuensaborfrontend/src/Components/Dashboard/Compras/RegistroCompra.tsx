...
const RegistroCompra = () => {
  ...
  const preselectedInsumoId = (location.state as { insumoId?: number } | null)
    ?.insumoId;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const selectedInsumo = insumos.find(
      (i) => i.id === Number(selectedInsumoId),
    );
      ...
      <div>
              ...
              <Form onSubmit={handleSubmit}>
                ...
                <div className="d-flex justify-content-end">
                  <Button
                    variant="primary"
                    type="submit"
                    disabled={loading || !selectedInsumoId}
                  >
                    {loading ? (
        ...
        <div>
          <button
            ...
            onClick={() => navigate("/dashboard/compras/list")}
          >
